...
void RobloxView::doTeleport(std::string url, std::string ticket, std::string script)
{
	...
	NSString *ticketString = [NSString stringWithCString:ticket.c_str() encoding:NSUTF8StringEncoding];
	NSString *urlString = [NSString stringWithCString:url.c_str() encoding:NSUTF8StringEncoding];
	NSString *scriptString = [NSString stringWithCString:script.c_str() encoding:NSUTF8StringEncoding];
