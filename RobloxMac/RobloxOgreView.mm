...
- (void) toggleFullScreen
{
	...
	if (fullScreen)
	{
        ...
        dispatch_async(dispatch_get_main_queue(),^{
            [wnd setStyleMask:NSWindowStyleMaskBorderless];
	...
	else
	{
        dispatch_async(dispatch_get_main_queue(),^{
            ...
            [wnd setStyleMask:NSWindowStyleMaskResizable | NSWindowStyleMaskTitled | NSWindowStyleMaskClosable | NSWindowStyleMaskMiniaturizable];
...
- (BOOL)becomeFirstResponder
{
    ...
    if(!cursorHidden)
    {
        ...
        NSRect localWindowInAbsolute =  NSMakeRect(self.window.frame.origin.x, usableScreenRect.size.height - self.window.frame.origin.y - self.window.frame.size.height,
