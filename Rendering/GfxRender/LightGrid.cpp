...
#if defined(_WIN32) || (defined(__APPLE__) && !defined(RBX_PLATFORM_IOS) && !defined(__aarch64__))
#define SIMD_SSE2
#endif

#if (defined(RBX_PLATFORM_IOS) && !TARGET_IPHONE_SIMULATOR) || defined(__ANDROID__) || defined(__aarch64__)
#define SIMD_NEON
#endif
